"""
Central configuration for the Toronto Fire Response Time project.
Import from here rather than hardcoding paths or constants elsewhere.
"""
...
TARGET_COL   = "response_time_seconds"   # raw column; converted to minutes in train.py
TEST_SIZE    = 0.2
RANDOM_STATE = 42
MAX_RESPONSE_TIME_MINUTES = 120          # cap used when building target
...
HYDRANT_RADIUS_M  = 500     # radius used in add_hydrant_density()
...
# Incident types shown in the UI dropdown (subset of real values)
INCIDENT_TYPES = [
    "Medical",
    "Fire - Residential",
    "Fire - Commercial",
